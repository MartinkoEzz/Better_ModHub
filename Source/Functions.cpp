...
namespace Mod_Hub_Base
{
	...
	// here i am gonna add more example options to the menu :)

	// here i am gonnaa write the function and put it in loop
	// then i need to write it in Functions.h (check Functions.h)
	...
	// dont forget to do the process again!
	bool SuperJump = false;
	void superjump(bool toggle)
	{
		if (SuperJump) // or you can also type if (toggle) because you have bool toggle.
		{
	...
	void Function_update_Loop()
	{
		...
		neverwanted(NeverWanted); // here is the loop of never wanted option
		superjump(SuperJump);
