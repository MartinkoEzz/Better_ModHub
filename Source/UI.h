...
namespace Mod_Hub_Base::UserInterface
{
	...
	public:
		...
		Color m_OptionUnselectedBackgroundColor{ 0, 0, 0, 200 };
		...
		float m_DescriptionTextSize = 0.32f;
		Font m_DescriptionFont = Font::ChaletLondon;
		Color m_DescriptionBackgroundColor{ 0, 0, 0, 200 };
